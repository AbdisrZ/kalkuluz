 ...
 function hitungPersamaanLinear() {
  ...
  function hitungPersamaanKuadrat() {
    ...
    if (discriminant > 0) {
      ...
      document.getElementById('hasil_2').textContent = "x1 = " + x1 + ", x2 = " + x2  + "  dalam kuadrat = " + (-1 * b) + "+ √" + (b * b - 4 * a * c) + " / " + (2 * a) + " & " + (-1 * b) + "- √" + (b * b - 4 * a * c) + " / " + (2 * a);
    } else if (discriminant === 0) {
      var x = -b / (2 * a);
      document.getElementById('hasil_2').textContent = "x = " + x;
    } else {
      document.getElementById('hasil_2').textContent = "  imajiner, tidak dapat diselesaikan maka hasil terakhir adalah : x1 = " + (-1 * b) + "+ √" + (b * b - 4 * a * c)+"i" + " / " + (2 * a) + " & x2 = " + (-1 * b) + "- √" + (b * b - 4 * a * c)+"i" + " / " + (2 * a);
    }
  }
  ...
  function hitungPertidaksamaanKuadrat() {
    ...
    if (discriminant > 0) {
        ...
        document.getElementById('hasil_4').textContent = "  imajiner, tidak dapat diselesaikan maka hasil terakhir adalah : x1 = " + (-1 * b) + "+ √" + (b * b - 4 * a * c)+"i" + " / " + (2 * a) + " & x2 = " + (-1 * b) + "- √" + (b * b - 4 * a * c)+"i" + " / " + (2 * a);
      }
    }
